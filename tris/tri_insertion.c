...
/**
 * Trie un tableau d'entiers par insertion (in-place).
 * Analogie de la main au jeu de cartes : à chaque étape, la « carte »
 * courante est insérée à sa place dans la sous-séquence déjà triée.
 * Complexité : O(n²) en moyenne et pire cas, O(n) sur tableau déjà trié.
...
/**
 * Exo 1.b — Saisie d'un tableau au clavier puis tri par insertion.
 */
void exo1b() {
    int n;
 ...
 * `data/resultInser.txt` pour exploitation gnuplot.
 */
void exo3() {
